...
class Work extends React.Component {
  ...
  projects = [
    ...
    { id:2,
      name:"Playlistr",
      description: "App for creating customizable and social playlist. It uses the Last.fm API to search from a catalog and music and features a filter to allow you to search for specific keywords in titles or artists.",
